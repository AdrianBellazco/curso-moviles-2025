...
import 'package:hola_mundo/views/establecimientos/establecimiento_eliminar_view.dart';
...
class EstablecimientosListViewState extends State<EstablecimientosListView> {
              ...
              return GestureDetector(
                ...
                onLongPress: () async {
                  final confirm = await showDialog<bool>(
                    context: context,
                    builder:
                        (context) => const EstablecimientoEliminarView(
  ...
  child: (establecimiento.logo != null && establecimiento.logo!.isNotEmpty)
      ? Image.network(
